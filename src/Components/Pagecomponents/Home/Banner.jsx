...
const Banner = () => {
  return (
    ...
    <div className='h-[530px] bg-black w-screen relative shadow-[0px_1px_8px_0px_rgba(117,117,117,0.08)]   '>
        ...
        <div className='bg-[linear-gradient(to_right,_#FDF2DD,_#FFE4B180,_#FEE8BE66,_#FDF2DDCC)] absolute top-0 left-0 right-0 bottom-0 bg-[#FDF2DD]/80'></div>
      ...
      <div className='w-[718px] flex flex-col gap-3  justify-center   '>
        <h1 className='font-playfair text-5xl font-semibold tracking-[1.92px] text-[#9B4E2B]'>50% Off 
          <span className='font-playfair text-[#D9A441] text-5xl font-semibold ml-4 '>Spotlight</span>
          </h1>
         ...
         <div className='flex items-center gap-5 mt-3'>
          ...
          <div>
              <button className="font-poppins bg-[#BA4A20] text-lg font-medium text-white w-[155px] h-[48px] rounded-lg mt-7">
                Shop Now
              </button>
            </div>
      </div>
